...
INSERT INTO Player VALUES
	(1, 'Miroslav Klose', 'Germany', 16, 4, 20, 24),
	(2, 'Ronaldo Nazário', 'Brazil', 15, 4, 19, 19),
	(3, 'Lionel Messi', 'Argentina', 13, 8, 21, 26),
	(4, 'Pelé', 'Brazil', 12, 5, 17, 14),
	(5, 'Thomas Müller', 'Germany', 12, 6, 18, 16),
	(6, 'Cristiano Ronaldo', 'Portugal', 8, 2, 10, 22),
	(7, 'Kylian Mbappé', 'France', 12, 2, 14, 14),
	(8, 'Johan Cruyff', 'Netherlands', 3, 4, 7, 7),
	(9,'Zinedine Zidane', 'France', 5, 2, 7, 12),
	(10, 'Wayne Rooney', 'England', 7, 3, 10, 15);
